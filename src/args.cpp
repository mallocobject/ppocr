...
DEFINE_string(image_dir, "./images", "Dir of input image.");
DEFINE_string(
	type, "structure",
...
DEFINE_string(cls_model_dir, "./models/ch_ppocr_mobile_v2.0_cls_slim_infer", "Path of cls inference model.");
...
DEFINE_string(rec_char_dict_path, "./dicts/ppocr_keys_v1.txt",
	"Path of dictionary.");
DEFINE_int32(rec_img_h, 48, "rec image height");
DEFINE_int32(rec_img_w, 320, "rec image width");

// layout model related
DEFINE_string(layout_model_dir, "./models/picodet_lcnet_x1_0_fgd_layout_table_infer", "Path of table layout inference model.");
DEFINE_string(layout_dict_path,
	"./dicts/layout_table_dict.txt",
	"Path of dictionary.");
...
DEFINE_string(table_model_dir, "./models/ch_ppstructure_mobile_v2.0_SLANet_infer", "Path of table structure inference model.");
...
DEFINE_string(table_char_dict_path,
	"./dicts/table_structure_dict_ch.txt",
	"Path of dictionary.");
